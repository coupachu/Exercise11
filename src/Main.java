...
class PreasureSensor implements WeatherDataSource {
    private double currentPreasure;
    private List<WeatherDataListener> listeners = new ArrayList<>();
    ...
    public double getCurrentPreasure() {
        return currentPreasure;
    }

    private void updatePreasure() {
        // read from humidity sensor
        currentPreasure = new Random().nextDouble();
    }
    ...
    @Override
    public void update() {
        System.out.println("Preasure Sensor: getting new data.");
        updatePreasure();
        for (WeatherDataListener listener: listeners) {
            listener.updateData(new WeatherData("Preasure", currentPreasure) {
                @Override
                public String getUpdateMessage() {
                    return "Preasure updated to " + currentPreasure;
                }
            });
        }
